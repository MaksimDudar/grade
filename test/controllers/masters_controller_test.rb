...
class MastersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create master" do
    assert_difference("Master.count") do
      post masters_url, params: { master: { driver: @master.driver, manager: @master.manager, rating: @master.rating, strana: @master.strana, strana1: @master.strana1, truck: @master.truck } }
    end
  ...
  test "should update master" do
    patch master_url(@master), params: { master: { driver: @master.driver, manager: @master.manager, rating: @master.rating, strana: @master.strana, strana1: @master.strana1, truck: @master.truck } }
